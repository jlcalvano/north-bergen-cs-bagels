    ...
    <div className="space-y-0.5">
      ...
      <div className="max-w-xs">
          ...
          <div className="flex flex-row space-x-4">
            ...
            <button type="button" className="mt-1 border-red-30 bg-red-500 hover:bg-red-700 text-white font-bold py-1 px-1 rounded" onClick={()=> getData(values.props.passcode).then(res => {
